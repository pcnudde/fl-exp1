# Federated learning with nvflare collab api using POC mode
# POC mode runs server and clients as separate processes on localhost
import torch
...
if __name__ == '__main__':
    # POC mode runs separate processes for server and each client
    # More realistic simulation than SimEnv but runs locally
    recipe = FoxRecipe(job_name="fox_training_poc", min_clients=3)
